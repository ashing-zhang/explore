...
export type DashboardOrdersResponse = {
  dataDate: string;
  kpis: {
    orderCount: { value: number; deltaPct: number };
    gmvCny: { value: number; deltaPct: number };
    aovCny: { value: number; deltaPct: number };
    cancelRatePct: { value: number; deltaPct: number };
    fulfillRatePct: { value: number; deltaPct: number };
  };
  charts: {
    orderTrend: {
      dates: string[];
    ...
    channelShare: { name: string; value: number }[];
    domesticTop10: { name: string; value: number }[];
  };
  table: {
    page: number;
    pageSize: number;
...
export type DashboardMarketResponse = {
  dataDate: string;
  kpis: {
    supplyRooms: { value: number; deltaPct: number };
    revparCny: { value: number; deltaPct: number };
    occPct: { value: number; deltaPct: number };
    adrCny: { value: number; deltaPct: number };
    competitorCount: { value: number; deltaPct: number };
  };
  charts: {
    priceTrend: {
      dates: string[];
